...
describe("Lending Smart Contract", async () => {
  ...
  it("Test Init and Fund Bank", async () => {
    ...
    console.log("Init USDC Bank Transaction Signature:", initUSDCBankTx);
    ...
    console.log("Mint USDC to Bank Transaction Signature:", mintTx);
    ...
    it("Test Init User", async () => {
      ...
      console.log("Init User Transaction Signature:", initUserTx);
    });
  });
